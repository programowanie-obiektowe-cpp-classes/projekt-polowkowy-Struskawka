...
class gra {
	...
	void graj() {
		...
		while(fi.getstan_konta()>0&&fi.getwartosc_firmy()<=cel){//poprawione//
		...
		switch (opcja) {
					case 1:	{cout<<endl;fi.drukuj_prac();cout<<endl;system("pause");break;}
					case 2:	{cout<<endl;fi.drukuj_kred();cout<<endl;system("pause");break;}
					case 3:	{cout<<endl;cout<<"wartosc firmy: "<<fi.getwartosc_firmy()<<endl<<endl;system("pause");break;}
					case 4:	{cout<<endl;cout<<"stan konta: "<<fi.getstan_konta()<<endl<<endl;system("pause");break;}
	...
	private:
	int tura;
	static const int konto_start=1;
